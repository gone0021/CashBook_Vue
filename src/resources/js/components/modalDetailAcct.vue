    ...
    <div id="detailAccount" class="ui-widget-content">
      <form action="./items/update" method="POST">
          ...
          <tbody class="detailAccount">
            ...
            <tr class="detailTop">
              ...
              <td class="detailAccountCredit" id="detailAccountCredit0">
                ...
                <div
                  class="detailAccountCreditCategory"
                  id="detailAccountCreditCategory"
                >
              ...
              <td colspan="2">
                <div class="detailAccountComment">
                  <div class="detailAccountCommentSubmit">
                    <label
                      for="detailAccountComment"
                      class="detailAccountCommentLabel"
                      >コメント：</label
                    >
        ...
        <div class="detailAccountBtn col-md-10 mb-3">
          <button id="detailAccountEdit" class="btn btn-info btnEdit mr-3">
            Edit
          </button>
          <input
            type="submit"
