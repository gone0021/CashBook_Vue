    ...
    <form method="POST" action="{{ url('register_add') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 mt-2 mb-0">
                ...
                <input id="user_name" type="hidden" class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ $user_name }}" required autocomplete="user_name" autofocus>
